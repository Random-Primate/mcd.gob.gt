...
puts '-------------------'
Implemento.create([
  { description: 'Juegos de uniformes de papi fútbol niño', name: 'Uniforme Papi Fútbol Niño', available: 1000, reserved: 0, solicited: 0, piezas: 8, color: '#F7464A'},
  { description: 'Juegos de uniformes de papi fútbol femenino', name: 'Uniforme Papi Fútbol Femenino', available: 500, reserved: 0, solicited: 0, piezas: 8, color: '#46BFBD' },
  { description: 'Juegos de uniformes de papi fútbol masculino', name: 'Uniforme Papi Fútbol Masculino', available: 2000, reserved: 0, solicited: 0, piezas: 8, color: '#FDB45C' },
  { description: 'Juegos de uniformes de fútbol masculino', name: 'Uniforme Fútbol Masculino', available: 4000, reserved: 0, solicited: 0, piezas: 15, color: '#FF5A5E' },
  { description: 'Juegos de uniformes de fútbol femenino', name: 'Uniforme Fútbol Femenino', available: 1000, reserved: 0, solicited: 0, piezas: 15, color: '#5AD3D1' },
  { description: 'Juegos de uniformes de fútbol niño', name: 'Uniforme Fútbol Niño', available: 2000, reserved: 0, solicited: 0, piezas: 15, color: '#FFC870' },
  { description: 'Juegos de uniformes de basquetbol masculino', name: 'Uniforme Basquetbol Masculino', available: 600, reserved: 0, solicited: 0, piezas: 8, color: '#0BC4D9' },
  { description: 'Juegos de uniformes de basquetbol femenino', name: 'Uniforme Basquetbol Femenino', available: 400, reserved: 0, solicited: 0, piezas: 8, color: '#F2AD85' },
  { description: 'Juegos de uniformes de voleibol masculino', name: 'Uniforme Voleibol Masculino', available: 600, reserved: 0, solicited: 0, piezas: 8, color: '#068BBF' },
  { description: 'Juegos de uniformes de voleibol femenino', name: 'Uniforme Voleibol Femenino', available: 400, reserved: 0, solicited: 0, piezas: 8, color: '#F27E43' },
  { description: 'Juegos de uniformes multidisciplinario masculino', name: 'Uniforme Multidisciplinario Masculino', available: 2000, reserved: 0, solicited: 0, piezas: 20, color: '#E46763' },
  { description: 'Juegos de uniformes multidisciplinario femenino', name: 'Uniforme Multidisciplinario Femenino', available: 500, reserved: 0, solicited: 0, piezas: 20, color: '#9ED0B5' },
  { description: 'Juegos de uniformes multidisciplinario niño', name: 'Uniforme Multidisciplinario Niño', available: 500, reserved: 0, solicited: 0, piezas: 20, color: '#ABB0B3' },
  { description: 'Pares de zapatos de fútbol', name: 'Zapatos de Fútbol', available: 34992, reserved: 0, solicited: 0, piezas: 1, color: '#BF4226' },
  { description: 'Pares de zapatos de papi fútbol', name: 'Zapatos de Papi Fútbol', available: 24936, reserved: 0, solicited: 0, piezas: 1, color: '#9DC6BC' },
  { description: 'Pares de zapatos tenis deportivo', name: 'Zapatos Tenis Deportivos', available: 25068, reserved: 0, solicited: 0, piezas: 1, color: '#168C80' },
  { description: 'Pares de zapatos tenis para trotar', name: 'Zapatos para Trotar', available: 35004, reserved: 0, solicited: 0, piezas: 1, color: '#D94A64' },
  { description: 'Juego de medallas de oro, plata, y bronce', name: 'Juego de Medallas', available: 2000, reserved: 0, solicited: 0, piezas: 3, color: '#E6AE59' },
  { description: 'Juego de trofeos de oro, plata, y bronce', name: 'Juego de Trofeos', available: 3000, reserved: 0, solicited: 0, piezas: 3, color: '#37364A' },
  { description: 'Balón de fútbol No. 4', name: 'Balón No.4 Futbol', available: 35000, reserved: 0, solicited: 0, piezas: 1, color: '#FFEEAD' },
  { description: 'Balón de fútbol No. 5', name: 'Balón No.5 Futbol ', available: 40000, reserved: 0, solicited: 0, piezas: 1, color: '#96CEB4' },
  { description: 'Balón de basquetbol', name: 'Balón de Basquetbol', available: 25000, reserved: 0, solicited: 0, piezas: 1, color: '#AAD8B0' },
  { description: 'Balón de voleibol', name: 'Balón de Voleibol', available: 10000, reserved: 0, solicited: 0, piezas: 1, color: '#FF6F69' }
])
